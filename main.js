            ...
            M.launch=function()
                ...
                M.renderInventory = function() {
                    ...
                    for (var i in M.inventory) {
                        ...
                        `onmousedown="M.dragPiece(i);"`+
                        `onmouseover="Game.tooltip.draw(this, '<div style=\'text-align:center;\'><b>`+piece.piece.name+`</b></div><div style=\'text-align:center;\'><b>`+piece.rarity[0].name+`</b></div>');"`+
                        `id="piece`+i+`">`;
                ...
                M.dragPiece = function(index) {   
                    ...
                    var div = l('piece' + M.inventory.indexOf(what));
                ...
                M.drawBoard = function() {
                    ...
                    for (var i = 0; i < M.boardSize; i++) {
                        ...
                        for (var j = 0; j < M.boardSize; j++) {
                            ...
                            `onmouseover="Game.tooltip.draw(this, '<div style=\'text-align:center;\'><b>Tile `+i+`-`+j+`</b></div>');"`+
